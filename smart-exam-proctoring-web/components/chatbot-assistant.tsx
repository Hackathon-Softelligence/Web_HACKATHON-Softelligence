...
import { MessageCircle, X, Send, HelpCircle, AlertTriangle, Settings, Bug } from "lucide-react"
...
const quickActions = [
  ...
  },
  {
    ...
    message: "Can you explain the different types of alerts and their severity levels?",
  },
  {
    icon: Settings,
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      type: "bot",
      content: "Hello! I'm your ProctorView assistant. How can I help you today?",
  ...
  if (!isOpen) {
    return (
      <Button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 rounded-full shadow-lg bg-exam-primary hover:bg-exam-primary/90 z-50"
        size="lg"
      >
      ...
      <CardHeader className="pb-3">
        <CardTitle className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-exam-primary rounded-full flex items-center justify-center">
              ...
              <div key={message.id} className={`flex ${message.type === "user" ? "justify-end" : "justify-start"}`}>
                ...
                >
                  <Avatar className="w-6 h-6">
                    {message.type === "bot" ? (
                      <div className="w-6 h-6 bg-exam-primary rounded-full flex items-center justify-center">
                  ...
                  <div
                    className={`rounded-lg px-3 py-2 text-sm ${
                      message.type === "user" ? "bg-exam-primary text-white" : "bg-gray-100 text-gray-900"
                    }`}
                  >
